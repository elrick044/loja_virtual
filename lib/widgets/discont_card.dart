...
class DiscontCard extends StatelessWidget {
  const DiscontCard({Key? key}) : super(key: key);
        ...
        children: [
          Padding(
            ...
            child: TextFormField(
              ...
              initialValue: CartModel.of(context).couponCode,//CartModel.of(context).couponCode ?? ""
                    ...
                    (docSnap){
                      if(docSnap.data() != null){
                        Scaffold.of(context).showSnackBar(
                          SnackBar(content: Text("Desconto de ${docSnap["percent"]}% aplicado!"),
                            backgroundColor: Theme.of(context).primaryColor,
                          )
                        );
                      }else{
